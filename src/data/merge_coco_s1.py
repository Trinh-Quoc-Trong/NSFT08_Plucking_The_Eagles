...
if __name__ == '__main__':
    # cấu hình các tham số trực tiếp vào code
    
    # danh sách các file json đầu vào 
    input_files_to_process = [
        r'data\raw\333.v1i.coco\train\_annotations.coco.json',
        r'data\raw\airplane augmenter.v1i.coco\train\_annotations.coco.json',
        r'data\raw\Airplane.v1i.coco\test\_annotations.coco.json',
        r'data\raw\Airplane.v1i.coco\train\_annotations.coco.json',
        r'data\raw\Airplane.v1i.coco\valid\_annotations.coco.json',
        ...
        r'data\raw\fight_10000_images\test\_annotations.coco.json',
        r'data\raw\fight_10000_images\train\_annotations.coco.json',
        r'data\raw\fight_10000_images\valid\_annotations.coco.json',
        r'data\raw\planes.v2i.coco\train\_annotations.coco.json',
        r'data\raw\planes.v2i.coco\valid\_annotations.coco.json',
        r'data\raw\yolov8veesles.v1i.coco\test\_annotations.coco.json',
        r'data\raw\yolov8veesles.v1i.coco\train\_annotations.coco.json',
        r'data\raw\yolov8veesles.v1i.coco\valid\_annotations.coco.json',
    ]
    
    # thư mục để lưu dữ liệu mới 
    output_dataset_directory = r'data\interim\merged_fighter_jets'
    
    # danh sach cac class can lay
